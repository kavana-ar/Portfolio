...
|---|---|---|
|🛍️ Customer Shopping Behavior Analysis	| Python, Pandas, PostgreSQL, Power BI, SQL |	Analyzed customer shopping behavior using Python and Pandas. Cleaned and transformed customer data, handled missing values, created age groups and purchase-frequency features, loaded the cleaned data into PostgreSQL, and performed data analysis to identify useful customer and purchasing patterns. |
